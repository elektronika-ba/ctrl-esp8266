...
#include "include/flash_param.h"

// All data saved/loaded needs to be in multiples of 4. To store a single "char" you must padd it with 3 dummy memory locations.
