...
unsigned long gTXbase = 1; // we need this variable because we are not going to keep all sent+acknowledged messages in database like we do on Server implementation
